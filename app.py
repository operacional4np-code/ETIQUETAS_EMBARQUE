...
def gerar_etiquetas_pdf(sigla, quantidade, dados):
    ...
    # Estilo compacto para os blocos de dados
    ...
    for i in range(1, quantidade + 1):
        ...
        # --- 3. BLOCOS DE TEXTO (Ajustados para não colidir com o título grande) ---
        # Posicionamos o Expedidor logo abaixo do "USED" (52mm - 18mm de margem)
        ...
        p1.drawOn(c, 4*mm, 35*mm) # Expedidor
        
        p2 = Paragraph(rec, style_normal)
        p2.wrapOn(c, 92*mm, 20*mm)
        p2.drawOn(c, 4*mm, 20*mm) # Recebedor
        
        # --- 4. DATA DE EXPEDIÇÃO (Rodapé) ---
